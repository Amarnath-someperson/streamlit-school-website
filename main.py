...
st.beta_page_config(page_title='Student Analysis', page_icon = 'https://images.app.goo.gl/46ngdkqwdCEaQoWb9')

with open('./config.yaml') as file:
    CONFIG = yaml.load(file, Loader=SafeLoader)

st.beta_set_page_config(page_title='your_title', page_icon = 'https://images.app.goo.gl/46ngdkqwdCEaQoWb9', layout = 'wide', initial_sidebar_state = 'auto')
